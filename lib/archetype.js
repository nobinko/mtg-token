...
const NOISE_WORDS = /\b(top\s*\d*|rank\s*\d*|decklist|decklists|standard|pioneer|modern|legacy|event|championship|regional|spotlight|platinum|mythic|rank\s+player|magic\s+play|coverage)\b/gi;
